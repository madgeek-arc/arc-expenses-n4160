...
public class RequestApprovalServiceImpl extends GenericService<RequestApproval> {
        ...
        sm.getStateMachineAccessor()
                .doWithAllRegions(sma -> {
                    ...
                    sma.resetStateMachine(new DefaultStateMachineContext<>(
                            NormalStages.valueOf((requestApproval.getCurrentStage() == null ? NormalStages.Stage1.name() : requestApproval.getCurrentStage())), null, null, null));
    ...
    public void finalize(RequestApproval requestApproval){
        ...
        StateMachine<NormalStages, StageEvents> sm = this.build(requestApproval);
