...
public class RejectEmailEntity {
    ...
    public RejectEmailEntity(String request_id, String project_acronym, String creation_date, String final_amount, String subject, String url) {
